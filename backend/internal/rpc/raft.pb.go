...
type LogEntry struct {
	...
	Op            string                 `protobuf:"bytes,3,opt,name=op,proto3" json:"op,omitempty"` // "SET" | "DELETE" | "NOOP"
...
const file_internal_rpc_raft_proto_rawDesc = "" +
	"\n" +
	"\x17internal/rpc/raft.proto\x12\x04raft\"l\n" +
	"\bLogEntry\x12\x14\n" +
	...
	"\rconflict_term\x18\x04 \x01(\x04R\fconflictTerm2\x94\x01\n" +
	"\x04Raft\x12B\n" +
	"\vRequestVote\x12\x18.raft.RequestVoteRequest\x1a\x19.raft.RequestVoteResponse\x12H\n" +
	"\rAppendEntries\x12\x1a.raft.AppendEntriesRequest\x1a\x1b.raft.AppendEntriesResponseB5Z3github.com/jamesmartin6/quorum/backend/internal/rpcb\x06proto3"
